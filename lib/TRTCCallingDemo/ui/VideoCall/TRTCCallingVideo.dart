...
import 'package:tencent_im_sdk_plugin_example/TRTCCallingDemo/model/TRTCCalling.dart';
import 'package:tencent_im_sdk_plugin_example/TRTCCallingDemo/model/TRTCCallingDelegate.dart';
import 'package:tencent_im_sdk_plugin_example/TRTCCallingDemo/ui/base/CallTypes.dart';
...
class _TRTCCallingVideoState extends State<TRTCCallingVideo> {
                      ...
                      children: [
                        Container(
                          ...
                          child: InkWell(
                            ...
                            child: Image.asset(
                              'images/callingDemo/switch-camera.png',
                              height: 32,
  ...
  getButtomWidget() {
    var callSomeBtnList = [
      _currentCallStatus == CallStatus.answer
          ? ExtendButton(
              imgUrl: _isMicrophoneOff
                  ? "images/callingDemo/microphone-off.png"
                  : "images/callingDemo/microphone-on.png",
              tips: "麦克风",
              onTap: () {
                onMicrophoneTap();
              },
      ...
      ExtendButton(
        imgUrl: "images/callingDemo/hangup.png",
        tips: "挂断",
        onTap: () {
          onHangUpCall();
        },
      ...
      _currentCallStatus == CallStatus.answer
          ? ExtendButton(
              imgUrl: _callingScenes == CallingScenes.VideoOneVOne
                  ? _isCameraOff
                      ? "images/callingDemo/camera-off.png"
                      : "images/callingDemo/camera-on.png"
                  : _isHandsFree
                      ? "images/callingDemo/trtccalling_ic_handsfree_enable.png"
                      : "images/callingDemo/trtccalling_ic_handsfree_disable.png",
              tips:
    ...
    if (_currentCallType == CallTypes.Type_Being_Called &&
      ...
      callSomeBtnList.insert(
        3,
        ExtendButton(
          imgUrl: "images/callingDemo/trtccalling_ic_dialing.png",
          tips: "接听",
          onTap: () {
            onAcceptCall();
          },
